...
└─ agent-relay/
   ...
   └─ src/
      ...
      ├─ agent/                   # AgentLoop / IntentRouter / WorkflowRouter / WorkflowExecutor / PlanWorkflow / EditProposalWorkflow / EditExecutionWorkflow / EditVerificationWorkflow / PlanReportWorkflow / PlanCompileWorkflow / TaskExecutionWorkflow / RunVerifyWorkflow / RunPolicyManager / RunPolicyTypes / BudgetManager / Planner
