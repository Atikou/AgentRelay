...
└─ agent-relay/
   ...
   └─ src/
      ...
      ├─ agent/                   # AgentLoop / IntentRouter / WorkflowRouter / WorkflowExecutor / PlanWorkflow / PlanReportWorkflow / RunVerifyWorkflow / RunPolicyManager / RunPolicyTypes / BudgetManager / Planner
