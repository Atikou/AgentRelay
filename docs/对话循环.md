...
```bash
npm run test:loop   # 假 chat 驱动：工具→最终 / onStep / agent_decision / WorkflowExecutor / EditExecutionWorkflow / EditAutoVerificationWorkflow / EditVerificationWorkflow / 分项预算耗尽收尾 / 定位统计 / 计划模式限写 / 未知工具不崩
