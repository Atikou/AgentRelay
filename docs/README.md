...
4. [模型路由 Level 与 Capability 分层设计](模型路由Level与Capability分层设计.md) — Level 0–3 + 多模态能力画像
5. [纯聊天人格层](纯聊天人格层.md) — 零工具、零权限的本地虚拟人物聊天层 MVP 与后续规划
6. [自审核记录](自审核记录.md) — 演进审计（保留历史，最新在上）
